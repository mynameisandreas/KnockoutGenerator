...
using AndreasGustafsson.KnockoutGenerator;

namespace KnockoutGenerator_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new KnockoutGeneratorPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(AndreasGustafsson.KnockoutGenerator.GuidList.guidKnockoutGeneratorCmdSet, (int)AndreasGustafsson.KnockoutGenerator.PkgCmdIDList.cmdidMyCommand);
